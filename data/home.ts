/** Headline overlaid on the full-bleed hero image. */
export const heroHeadline = "We are Brown Derivatives Investment Group.";

/** Body copy for the "Who We Are" section. One string per paragraph. */
export const whoWeAre: string[] = [
  ...
  "Now, with $150k of simulated funds and a dream, they have set out to demystify the world of derivatives with a fun, hands-on approach to trading.",
];
